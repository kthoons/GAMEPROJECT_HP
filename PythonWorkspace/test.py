...
# 년도 선택
pyautogui.click(pyautogui.locateOnScreen(f"mecro_img/2020.png"))

# 월 선택
pyautogui.click(pyautogui.locateOnScreen(f"mecro_img/3m.png"))
time.sleep(0.5)


#이름 선택
browser.find_element_by_xpath("//*[@id='daily_check_list']/table/tbody/tr[1]/td[3]").click()
        
time.sleep(0.5)

pyautogui.locateOnScreen("mecro_img/5floor.png", grayscale=True)


# Box(left=46, top=203, width=29, height=28)
# 206,203
