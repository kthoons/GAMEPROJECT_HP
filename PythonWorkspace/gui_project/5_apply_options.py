...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        ...
        initialdir=r"C:\Users\강태훈\Desktop\PythonWorkspace")
...
def browse_dest_path():
    ...
    if folder_selected == '': # 사용자가 취소를 누를 때 # "" 도 가능
        print("폴더 선택 취소")
        return
...
def merge_image():
    ...
    try:
        ...
        # 계산식
        # 100 * 60 이밎가 있음. -> width 를 80 으로 줄이면 height 는?
        ...
        # y' = x'y / x = img_width * x.size[1] / x.size[0]
