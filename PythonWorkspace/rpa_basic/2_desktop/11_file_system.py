...
# 파일 경로에서 폴더 정보 가져오기
# print(os.path.dirname(r"C:\Users\강태훈\Desktop\PythonWorkspace/my_file.txt"))
...
# print(ctime)
# # 날짜 정보를 srtftime 을 통해서 연월일 시분초 형태로 출력
# print(datetime.datetime.fromtimestamp(ctime).strftime("%Y%m%d %H:%M:%S"))

# # 파일의 수정 날짜
# mtime = os.path.getmtime("go_up.png")
# print(datetime.datetime.fromtimestamp(mtime).strftime("%Y%m%d %H:%M:%S"))

# # 파일의 마지막 접근 날짜
# atime = os.path.getatime("go_up.png")
...
# print(os.path.isdir("img.png"))
# print(os.path.isfile("img.png"))
...
# 파일 복사하기
# 어떤 파일을 폴더 안으로 복사하기
# shutil.copy("go_up.png", "test_folder") # 원본 경로, 대상 경로
# 어떤 파일을 폴더 안에 새로운 파일 이름으로 복사하기
# shutil.copy("go_up.png", "test_folder/copied_run_btn.png") # 원본 파일 경로, 대상 경로(변경된 파일명까지)
# shutil.copyfile("go_up.png", "test_folder/copied_run_btn_2.png") # 원본 파일 경로, 대상 파일 경로

# shutil.copy("go_up.png", "test_folder/copy.png")
# shutil.copy2("go_up.png", "test_folder/copy2.png") # 원본 파일 경로, 대상 폴더(파일) 경로
